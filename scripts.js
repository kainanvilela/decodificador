...
let textoDeEntrada = document.querySelector('#conteudo_ladoEsquerdo_texto_textoDeEntrada');
...
function ocultarImagemMensagem() {
    let imagemMensagem = document.querySelector('#conteudo_ladoDireito_imagem');
...
function ocultarMensagem() {
    if (textoDeSaida.value.trim() === '') {
        document.getElementById('conteudo_ladoDireito_texto').style.display = 'block';
    } else {
        document.getElementById('conteudo_ladoDireito_texto').style.display = 'none';
    }
}